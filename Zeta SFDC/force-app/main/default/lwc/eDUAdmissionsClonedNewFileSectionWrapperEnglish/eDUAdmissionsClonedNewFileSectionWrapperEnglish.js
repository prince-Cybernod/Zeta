...
import { OMNIDEF } from './eDUAdmissionsClonedNewFileSectionWrapperEnglish_def.js';
import tmpl from './eDUAdmissionsClonedNewFileSectionWrapperEnglish.html';
import tmpl_nds from './eDUAdmissionsClonedNewFileSectionWrapperEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class eDUAdmissionsClonedNewFileSectionWrapperEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
