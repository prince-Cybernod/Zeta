...
import { OMNIDEF } from './programAssessmentAssessmentIntakeEnglish_def.js';
import tmpl from './programAssessmentAssessmentIntakeEnglish.html';
import tmpl_nds from './programAssessmentAssessmentIntakeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class programAssessmentAssessmentIntakeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
