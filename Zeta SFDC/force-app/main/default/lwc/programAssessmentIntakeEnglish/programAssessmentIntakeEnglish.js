...
import { OMNIDEF } from './programAssessmentIntakeEnglish_def.js';
import tmpl from './programAssessmentIntakeEnglish.html';
import tmpl_nds from './programAssessmentIntakeEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class programAssessmentIntakeEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
