...
import { OMNIDEF } from './programAssessmentIntakeAssessmentEnglish_def.js';
import tmpl from './programAssessmentIntakeAssessmentEnglish.html';
import tmpl_nds from './programAssessmentIntakeAssessmentEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class programAssessmentIntakeAssessmentEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
